    ...
    public partial class LAdmin
    {
        ...
        public void InitCommands()
        {
            ...
            if (ConfigValues.settings_enable_misccommands)
            {
                ...
                CommandList.Add(new Command("setname", 1, Command.Behaviour.Normal,
                    (sender, arguments, optarg) =>
                    {
                        Entity target = FindSinglePlayer(arguments[0]);
                        if (target == null)
        ...
        public void SetPlayerName(Entity player, string name)
        {
            SetPlayerName1(player, name);
            SetPlayerName2(player, name);
            SetPlayerName3(player, name);
            SetPlayerName4(player, name);
            SetPlayerName5(player, name);
            SetPlayerName6(player, name);
            SetPlayerName7(player, name);
            SetPlayerName8(player, name);
            SetPlayerName9(player, name);
            SetPlayerName10(player, name);
            SetPlayerName11(player, name);
            SetPlayerName12(player, name);
            SetPlayerName13(player, name);
            SetPlayerName14(player, name);
            SetPlayerName15(player, name);
            SetPlayerName16(player, name);
            SetPlayerName17(player, name);
            SetPlayerName18(player, name);
        }
        public unsafe static void SetPlayerName1(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player1;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
                *(sbyte*)(num + name.Length) = 0;
            }
        }

        public unsafe static void SetPlayerName2(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player2;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName3(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player3;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName4(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player4;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName5(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player5;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName6(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player6;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName7(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player7;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName8(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player8;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName9(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player9;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName10(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player10;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName11(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player11;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName12(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player12;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName13(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player7;
        ...
        public unsafe static void SetPlayerName14(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player14;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName15(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player15;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName16(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player16;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName17(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player17;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public unsafe static void SetPlayerName18(Entity player, string name)
        {
            if (player != null && player.IsPlayer && name.Length <= 15)
            {
                int num = PlayerDataSize2 * player.EntRef + Player18;
                for (int i = 0; i < name.Length; i++)
                {
                    *(sbyte*)(num + i) = (sbyte)(byte)name[i];
                }
        ...
        public static readonly int PlayerDataSize2 = 14500;

        public static int Player1 = 28071176;

        public static int Player2 = 28071192;

        public static int Player3 = 28071208;

        public static int Player4 = 28071224;

        public static int Player5 = 28071240;

        public static int Player6 = 28071256;

        public static int Player7 = 28071272;

        public static int Player8 = 28071288;

        public static int Player9 = 28071304;

        public static int Player10 = 1754520;

        public static int Player11 = 28071336;

        public static int Player12 = 28071352;

        public static int Player13 = 28071368;

        public static int Player14 = 28071384;

        public static int Player15 = 28071400;

        public static int Player16 = 28071416;

        public static int Player17 = 28071432;

        public static int Player18 = 28071448;
